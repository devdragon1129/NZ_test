...
export declare class EventSubscriber extends EventDispatcher {
    private component;
    constructor(component: ISubscribableAPI);
    ...
    off(event: string | EventDispatcherBinding | Function): void;
}
