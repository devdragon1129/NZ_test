...
export declare type StorageEngine<T> = {
    load(): PromiseLike<T>;
    save(state: T): PromiseLike<void>;
};
export declare type MiddlewareWhitelist = string[] | ((action: Action) => boolean);
...
export declare type ReduxStore<T> = {
    dispatch: (action: Action) => void;
    getState: () => T;
};
export declare type Loader<T> = {
    (store: ReduxStore<T>): PromiseLike<any>;
};
export declare type StateMerger = {
