...
import { AuditInfo, AvailableContentResult, ContentFileHash, Entity, EntityId, EntityType, Fetcher, HealthStatus, Pointer, Profile, RequestOptions, ServerMetadata, ServerStatus, Timestamp } from 'dcl-catalyst-commons';
...
export declare class CatalystClient implements CatalystAPI {
    ...
    fetchOwnedThirdPartyWearables<B extends boolean>(ethAddress: EthAddress, thirdPartyId: string, includeDefinitions: B, options?: RequestOptions): Promise<OwnedWearables<B>>;
