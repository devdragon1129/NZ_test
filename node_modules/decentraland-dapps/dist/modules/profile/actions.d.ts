...
export declare const SET_PROFILE_AVATAR_ALIAS_REQUEST = "[Request] Set profile avatar alias";
export declare const SET_PROFILE_AVATAR_ALIAS_SUCCESS = "[Success] Set profile avatar alias";
export declare const SET_PROFILE_AVATAR_ALIAS_FAILURE = "[Failure] Set profile avatar alias";
export declare const setProfileAvatarAliasRequest: (address: string, alias: string) => import("typesafe-actions/dist/types").PayloadAction<"[Request] Set profile avatar alias", {
    address: string;
    alias: string;
}>;
export declare const setProfileAvatarAliasSuccess: (address: string, alias: string, version: number) => import("typesafe-actions/dist/types").PayloadAction<"[Success] Set profile avatar alias", {
    address: string;
    alias: string;
    version: number;
}>;
export declare const setProfileAvatarAliasFailure: (address: string, error: string) => import("typesafe-actions/dist/types").PayloadAction<"[Failure] Set profile avatar alias", {
    address: string;
    error: string;
}>;
export declare type SetProfileAvatarAliasRequestAction = ReturnType<typeof setProfileAvatarAliasRequest>;
export declare type SetProfileAvatarAliasSuccessAction = ReturnType<typeof setProfileAvatarAliasSuccess>;
export declare type SetProfileAvatarAliasFailureAction = ReturnType<typeof setProfileAvatarAliasFailure>;
