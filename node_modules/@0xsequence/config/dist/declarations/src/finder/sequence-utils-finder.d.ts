...
export declare class SequenceUtilsFinder implements ConfigFinder {
    ...
    findConfigForImageHash: (context: WalletContext, image: string, knownConfigs?: WalletConfig[]) => Promise<WalletConfig | undefined>;
    findCurrentImageHash: (context: WalletContext, provider: ethers.providers.Provider, address: string, knownConfigs?: WalletConfig[]) => Promise<{
        imageHash?: string;
        config?: WalletConfig;
    }>;
