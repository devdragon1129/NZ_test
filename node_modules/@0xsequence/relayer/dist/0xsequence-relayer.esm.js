...
import { sequenceTxAbiEncode, readSequenceNonce, computeMetaTxnHash, appendNonce, MetaTransactionsType, packMetaTransactionsData } from '@0xsequence/transactions';
...
class RpcRelayer extends BaseRelayer {
  constructor(options) {
    super(options);
    this.service = void 0;
    this.service = new RelayerService(options.url, fetchPonyfill().fetch);
  }
