...
var Navbar = /** @class */ (function (_super) {
        ...
        if (rightMenu) {
            ...
            return (React.createElement(React.Fragment, null,
                ...
                React.createElement("span", { className: "dcl account-wrapper ".concat(onClickAccount ? 'clickable' : ''), onClick: onClickAccount },
                    mana != null ? (React.createElement(Mana_1.Mana, { size: "small", title: "".concat(mana.toLocaleString(), " MANA") }, Number(mana.toFixed(2)).toLocaleString())) : null,
    ...
    Navbar.prototype.render = function () {
        var _a = this.props, activePage = _a.activePage, className = _a.className, isSignIn = _a.isSignIn, isFullscreen = _a.isFullscreen, isOverlay = _a.isOverlay, isFullWidth = _a.isFullWidth;
        ...
        return (React.createElement("div", { className: classes, role: "navigation" },
            React.createElement(Container_1.Container, { className: isFullWidth && 'full-width' },
